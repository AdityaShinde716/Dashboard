...
import AdityaShinde from './AdityaShinde.png';
...
export const EditorData = () => (
  <div>
    <h3>
      ...
      If you prefer to use your own text editor, you can also download this HTML file, edit it, and open it from the local filesystem in your browser. It does a slow runtime code transformation, so we would only recommend using this for simple demos.
      ...
      Learn React
      People come to React from different backgrounds and with different learning styles. Whether you prefer a more theoretical or a practical approach, we hope you will find this section helpful.
